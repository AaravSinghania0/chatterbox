...
import SidebarGroupChatList from "./Sidebar/SidebarGroupChatList";
	...
	return (
		<div className="fixed bg-zinc-50 border-b border-zinc-200 top-0 inset-x-0 py-2 px-4">
			<div className="w-full flex justify-between items-center">
				...
				>
					<Image src={chatterboxLogo} alt="" width={24} height={24} />
					{/* <Icons.Logo className="h-6 w-auto text-blue-700" /> */}
													...
													>
																	...
																	(option) => {
																		...
																		return (
																			<li key= {option.name}>
																				<Link
																					href={option.href}
																					className="text-slate-700 hover:text-blue-700 hover:bg-slate-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
																				>
																					<span className="text-slate-400 border-slate-200 group-hover:border-blue-700 group-hover:text-blue-700 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium bg-white">
														...
														<li className="-ml-6 mt-auto flex items-center">
															<div className="flex flex-1 items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-slate-900">
																<div className="relative h-8 w-8 bg-slate-50">
																	<Image
																		fill
